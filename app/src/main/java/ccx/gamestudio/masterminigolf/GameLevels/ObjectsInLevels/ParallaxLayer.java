...
public class ParallaxLayer extends Entity {
    ...
    public static class ParallaxEntity {
        ...
        final Shape mAreaShape;
        final boolean mIsScrollable;

        final float shapeWidthScaled;

        public ParallaxEntity(final float pParallaxFactor, final Shape pAreaShape) {
        ...
        public ParallaxEntity(final float pParallaxFactor, final Shape pAreaShape, final boolean mIsScrollable) {
            this.mParallaxFactor = pParallaxFactor;
            this.mAreaShape = pAreaShape;
            this.mIsScrollable = mIsScrollable;
            shapeWidthScaled = this.mAreaShape.getWidth() * this.mAreaShape.getScaleX();
        ...
        public ParallaxEntity(final float pParallaxFactor, final Shape pAreaShape, final boolean mIsScrollable, final float mReduceFrequency) {
            this.mParallaxFactor = pParallaxFactor;
            this.mAreaShape = pAreaShape;
            this.mIsScrollable = mIsScrollable;
