...
public class GameObjectsDesertGround {
    ...
    public String mPreviousAssetBasePath ="";
    public static TextureRegion bush;
    public static TextureRegion bushOne;
    public static TextureRegion cactus;
    public static TextureRegion cactusOne;
    public static TextureRegion cactusTwo;
    public static TextureRegion crate;
    public static TextureRegion grass;
    public static TextureRegion grassOne;
    public static TextureRegion sign;
    public static TextureRegion signArrow;
    public static TextureRegion skeleton;
    public static TextureRegion stone;
    public static TextureRegion stoneBlock;
